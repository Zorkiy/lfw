<?php
  ...
  try
  {
    ...
    if(!empty($_POST))
    {
      ...
      define("ADD_THEME", 1);
      $error = array();
      require_once("../utils/include.add_theme.handler.php");
    }
    // Задаём название
    $nameaction = "Новая тема";
    ...
    ?>
     ...
     <td>
        ...
        Используйте теги для выделения текста:<br>
    ...
    <tr><td><p class="fieldname">Тема:</td><td><input class=input  type=text name=sub size=74 maxlength=150 value='<?php echo htmlspecialchars($_POST['sub'], ENT_QUOTES); ?>'></td></tr>
    <?php
