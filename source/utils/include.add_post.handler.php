<?php
  ...
  ///////////////////////////////////////////////////////////
  // Блок проверки корректности добавления сообщения
  ///////////////////////////////////////////////////////////
  ...
  if(mysql_num_rows($idn))
  {
    ...
    if($hide == 'lock') $error[] = "Тема закрыта, сообщения добавлять нельзя";
  } else $error[] = "Тема закрыта, сообщения добавлять нельзя";
  ...
  if(mysql_num_rows($idn))
  {
    ...
    if($id_theme_check != $id_theme) $error[] = "Попытка ответа из другой темы";
  } else $error[] = "Сообщение, на которое вы хотите ответить не обнаружено";
  ...
  if(empty($error))
  {
    ...
    // Обновляем время последнего ответа для темы
    ...
    if(!mysql_query($query))
    {
      throw new ExceptionMySQL(mysql_error(), 
                               $query,
                              "Ошибка обновления параметров темы");
    }
